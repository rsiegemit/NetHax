...
def enter_level(
    ...
    terrain_new, _rooms, _active, _up, _dn, _vrng, _levl, _nfill, _vault_info = generate_main_branch_l1(rng, static_params)
...
def traverse_stair_cross_branch(
    ...
    if already_generated:
        ...
        if dst_branch == int(Branch.GNOMISH_MINES):
            ...
            from Nethax.nethax.state import StaticParams
            sp = StaticParams()
            dst_terrain, _r, _a, _u, _d, _vrng, _levl, _nfill, _vault_info = generate_main_branch_l1(rng, sp)
