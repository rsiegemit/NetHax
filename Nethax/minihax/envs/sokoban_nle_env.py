"""Gymnax-compatible NLE-style environment for Sokoban (Tier 4)."""
import jax
...
from Nethax.minihax.constants import NUM_ACTIONS_TIER4
...
class SokobanNLEEnv(EnvironmentNoAutoReset):
    """Base class for all Sokoban NLE environments.
...
# ============================================================================
# Individual Sokoban NLE environment classes
# ============================================================================

class Soko1aNLEEnv(SokobanNLEEnv):
    ...
    @property
    def name(self) -> str:
        return "Minihax-Soko1a-NLE-v0"


class Soko1bNLEEnv(SokobanNLEEnv):
    def world_gen(self, rng, params, static_params):
    ...
    @property
    def name(self) -> str:
        return "Minihax-Soko1b-NLE-v0"


class Soko2aNLEEnv(SokobanNLEEnv):
    def world_gen(self, rng, params, static_params):
    ...
    @property
    def name(self) -> str:
        return "Minihax-Soko2a-NLE-v0"


class Soko2bNLEEnv(SokobanNLEEnv):
    def world_gen(self, rng, params, static_params):
    ...
    @property
    def name(self) -> str:
        return "Minihax-Soko2b-NLE-v0"


class Soko3aNLEEnv(SokobanNLEEnv):
    def world_gen(self, rng, params, static_params):
    ...
    @property
    def name(self) -> str:
        return "Minihax-Soko3a-NLE-v0"


class Soko3bNLEEnv(SokobanNLEEnv):
    def world_gen(self, rng, params, static_params):
    ...
    @property
    def name(self) -> str:
        return "Minihax-Soko3b-NLE-v0"


class Soko4aNLEEnv(SokobanNLEEnv):
    def world_gen(self, rng, params, static_params):
    ...
    @property
    def name(self) -> str:
        return "Minihax-Soko4a-NLE-v0"


class Soko4bNLEEnv(SokobanNLEEnv):
    def world_gen(self, rng, params, static_params):
