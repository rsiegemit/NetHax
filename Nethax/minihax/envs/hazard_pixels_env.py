"""Gymnax-compatible pixel environment for Hazard (Tier 2).

Pixel-rendered versions of all Tier 2 hazard environments (lava, items, doors,
simple monsters).
"""
import jax
...
from Nethax.minihax.constants import NUM_ACTIONS_TIER2, TILE_SIZE
...
class HazardPixelsEnv(EnvironmentNoAutoReset):
    """Base class for all Tier 2 hazard pixel environments.
...
# ============================================================================
# Individual Hazard pixel environment classes
# ============================================================================

class LavaCrossingPixelsEnv(HazardPixelsEnv):
    def __init__(self):
...
class HideNSeekPixelsEnv(HazardPixelsEnv):
    def __init__(self):
...
class HideNSeekBigPixelsEnv(HazardPixelsEnv):
    def __init__(self):
...
class HideNSeekLavaPixelsEnv(HazardPixelsEnv):
    def __init__(self):
...
class HideNSeekMappedPixelsEnv(HazardPixelsEnv):
    def __init__(self):
...
class QuestEasyPixelsEnv(HazardPixelsEnv):
    def __init__(self):
...
class QuestMediumPixelsEnv(HazardPixelsEnv):
    def __init__(self):
...
class LockedDoorPixelsEnv(HazardPixelsEnv):
    def __init__(self):
...
class LockedDoorFixedPixelsEnv(HazardPixelsEnv):
    def __init__(self):
...
class TreasureDashPixelsEnv(HazardPixelsEnv):
    def __init__(self):
